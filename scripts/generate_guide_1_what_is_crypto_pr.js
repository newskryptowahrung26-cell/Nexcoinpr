...
const targetPath = path.join(rootDir, 'news', 'guides', 'what-is-crypto-pr.html');
...
console.log('Successfully generated what-is-crypto-pr.html with competitor landscape & keywords!');
